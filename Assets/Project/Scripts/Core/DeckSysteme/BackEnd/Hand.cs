...
namespace Core.DeckSysteme.BackEnd
{
    public class Hand
    {
        ...
        public List<CardInfoData> Cards { get; } = new List<CardInfoData>(GameMetrix.InitialPoolSize);
        public List<CardInfoData> SelectedCards { get; } = new List<CardInfoData>(GameMetrix.MaxSelectable);
        ...
        private readonly List<CardInfoData> buffer = new List<CardInfoData>(GameMetrix.MaxSelectable);
